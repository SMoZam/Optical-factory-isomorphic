    ...
    return (
        <React.Fragment>
            <div className="link-container">
                <NavLink className="one-navlink" activeClassName="active-link" exact to={`/verre/gammeverres/`} > Progressifs </NavLink>
                <NavLink className="one-navlink center-navlink" activeClassName="active-link" exact to={`/verre/gammeverres/unifocaux`} > Unifocaux </NavLink>
                <NavLink className="one-navlink" activeClassName="active-link" exact to={`/verre/gammeverres/solaires`} > Solaires </NavLink>
            </div>
            <div className="gamme-verres-container" >
                <Switch>
                    <Route exact path={`/verre/gammeverres/`}
                        render={() => <Progressifs  progressifsArray={progressifsArray} />} />
                    <Route path={`/verre/gammeverres/unifocaux`}
                        render={() => <Unifocaux unifocauxArray={unifocauxArray}  />} />
                    <Route path={`/verre/gammeverres/Solaires`}
