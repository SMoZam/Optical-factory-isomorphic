...
class ServicesStyleSection extends Component {
    constructor(props) {
        super(props);
        this.state = {
        }
    ...
    render() {
        ...
        return (
            <section className="style-section services-style-section"  >
                    ...
                    return (
                        <div className="style-section-wrapper" >
                            ...
                            <div className="style-section-left-container"  style={styles}  >
                                ...
                                <Link className="btn" to="/contact">{el.data.body[1].primary.button_label[0].text}</Link>
                            </div>
                        </div>)
                })}
...
export default ServicesStyleSection;