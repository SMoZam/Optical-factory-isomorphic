...
import ControlledSlide from './ControlledSlide'
...
export default class ControlledSlider extends Component {
    constructor(props) {
        ...
        this.mySliderInput = React.createRef()
            ...
            const content = [
                {
                    ...
                    imageMobile: nextProps.sliderData[0].Image1Mobile[0].url
                },
                {
                    image: nextProps.sliderData[0].Image2[0].url,
                    imageMobile: nextProps.sliderData[0].Image2Mobile[0].url
                },
                {
                    image: nextProps.sliderData[0].Image3[0].url,
                    imageMobile: nextProps.sliderData[0].Image3Mobile[0].url
                },
                {
                    image: nextProps.sliderData[0].Image4[0].url,
                    imageMobile: nextProps.sliderData[0].Image4Mobile[0].url
                },
                // {
                //     image: nextProps.sliderData[0].Image5[0].url,
                //     imageMobile: nextProps.sliderData[0].Image5Mobile[0].url
                // },
    ...
    componentDidMount() {
        if (this.mySliderInput.current.clientWidth <= 768) {
            ...
            const content = [
                {
                    ...
                    imageMobile: this.props.sliderData[0].Image1Mobile[0].url
                },
                {
                    image: this.props.sliderData[0].Image2[0].url,
                    imageMobile: this.props.sliderData[0].Image2Mobile[0].url
                },
                {
                    image: this.props.sliderData[0].Image3[0].url,
                    imageMobile: this.props.sliderData[0].Image3Mobile[0].url
                },
                {
                    image: this.props.sliderData[0].Image4[0].url,
                    imageMobile: this.props.sliderData[0].Image4Mobile[0].url
                },
                // {
                //     image: this.props.sliderData[0].Image5[0].url,
                //     imageMobile: this.props.sliderData[0].Image5Mobile[0].url
                // },
    ...
    slideWidth = () => {
        return document.querySelector('.controlled-slide').clientWidth
    }
            ...
            <React.Fragment>
                {sliderData[0] ?
                    <div className="controlled-slider">
                        ...
                        <div  ref={this.mySliderInput} className="controlled-slider-wrapper"
                            style={{
                            ...
                            }}>
                            {
                                this.state.content.map((oneContent, i) => (
                                    ...
                                    <ControlledSlide key={i} content={oneContent} displayMobile={this.state.displayMobile} />
                                ))
                            }
                        </div>
