...
class TheLunetteDetails extends React.Component {
    constructor(props) {
        super(props)
    ...
    loadProduct(id) {
        api.get(`/products/${id}`)
            .then(response => {
                ...
                const { productArray } = this.props.location.state;
                        ...
                        <section ref={this.myLunettesDetailsInput} className="product-details">
                            <div className="lunettes-detail-wrapper" >
                                ...
                                <div className="lunettes-img-container" >
                                    {/* <Link to={genderLink} > */}
                                    <Link to={{
                                        pathname: this.props.location.state ? genderLink : defaultGenderLink,
...
const LunetteDetails = withRouter(TheLunetteDetails);
export default LunetteDetails;